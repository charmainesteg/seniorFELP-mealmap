const resourceData = [
  ...
  {
    id: 2,
    header: "The Emergency Food Assistance Program (TEFAP)",
    text: "TEFAP is a federal program that helps supplement the diets of low-income individuals in Georgia, including the elderly, by providing them with emergency food and nutrition assistance at no cost. This program is available in all 159 counties in Georgia.",
    title: "What is TEFAP?"
  },
  {
    id: 3,
